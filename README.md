...
[![nous score](https://img.shields.io/badge/nous%20score-74%2F100-yellow)](docs/REPORT.md) <!-- nous-score-badge -->
...
Proprietary — all rights reserved. See [`LICENSE`](LICENSE). Every workspace manifest declares
`"license": "UNLICENSED"` and `"private": true`; none is published to a registry, and no permission
to use, copy, modify or distribute is granted except in writing. That file also says what it is
*not*: the terms of service for the hosted product are separate, at [`/legal/terms`](http://localhost:3000/legal/terms).
